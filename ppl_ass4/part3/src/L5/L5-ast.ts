...
import { join, map, zipWith,sortBy,identity,flatten } from "ramda";
...
import { isTVar, makeFreshTVar, parseTExp, unparseTExp, TExp,parseUnion } from './TExp';
...
export type CompoundExp = AppExp | IfExp | ProcExp | LetExp | LitExp | LetrecExp | SetExp | UnionTExp;
...
export const makeUnionExp = (components: TExp[]): UnionTExp => ({tag: "UnionTExp",components:components});
export const isUnionExp = (x: any): x is UnionTExp => x.tag === "UnionTExp";
